...
NOTASLIBRO = 'El libro del día es una recomendación literaria que se actualiza periodicamente, ofreciendo a los lectores una selección de obras destacadas para fomentar la lectura y el conocimiento. Fuente: biblioteca personal'
